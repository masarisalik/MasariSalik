...
class AddHosptalController extends GetxController {
  ...
  void _getUserLocation() async {
    ...
    if (permissionStatus.isGranted) {
      ...
      initialCameraPosition = CameraPosition(
        target:
            LatLng(37.7749, -122.4194), // Default to San Francisco coordinates
        zoom: 15,
      );
    }
  }
  ...
  Future<void> createHospital() async {
    ...
    try {
      ...
      if (userCredential.user != null) {
        ...
        CustomToast.successToast('Hosptial Account Created Successfully');
