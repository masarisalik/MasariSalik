...
class HospitalMapPatientScreen extends StatefulWidget {
  ...
  const HospitalMapPatientScreen(
      {Key? key,
  ...
  @override
  _HospitalMapPatientScreenState createState() =>
      _HospitalMapPatientScreenState();
}

class _HospitalMapPatientScreenState extends State<HospitalMapPatientScreen> {
  ...
  //       _showBottomSheet(context, name, hosId, phone, lat, lng);
